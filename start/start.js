// // ============ COUNTDOWN LOGIC ============
//     const targetDate = new Date('2025-12-30T22:03:20').getTime();
...
//     // ============ FIREWORK LOGIC (Simplified version) ============
...
const textLines = [
  ...
  { 
    text: "下一站2026<br>TRẠM TIẾP THEO：2026",
    delay: 1200,
    fontSize: "3em"  
  }
  ,
   { 
    text: "祝我们马到成功!<br>Chúc Bạn và tôi mã đảo thành công!", 
    delay: 1300,
    fontSize:"3em"  
  },
    { 
    text: "一顺百順<br>Mọi việc suôn sẻ, thuận buồm xuôi gió", 
    delay: 1300,
    fontSize: "3em"  
  },

    { 
    text: "平安喜乐<br>Bình an và hạnh phúc", 
    delay: 1300,
    fontSize: "3em"  
  },
    { 
    text: "心想事成<br>Mọi mong ước đều trở thành hiện thực", 
    delay: 1300,
    fontSize: "3em"  
  },
    { 
    text: "万事胜意<br>Mọi việc như ý", 
    delay: 1300,
    fontSize: "3em"  
  },
    { 
    text: "财源滚滚<br>Tài lộc dồi dào", 
    delay: 1300,
    fontSize: "3em"  
  },
    { 
    text: "好运连连<br>May mắn nối tiếp may mắn", 
    delay: 1200,
    fontSize: "3em"  
  },
    { 
    text: "2025你若不离<br>2025 nếu bạn không rời xa", 
    delay: 1200,
    fontSize: "3em"  
  },
    { 
    text: "2026我们继续<br>2026 chúng ta tiếp tục cùng nhau", 
    delay: 1200,
    fontSize: "3em"  
  },
  {
     text: "新年快乐，平安喜乐<br>Chúc Mừng Năm Mới - Vui Vẻ , Bình An !!", 
    delay: 10000,
    fontSize: "4em"  
  },
];
...
startButton.addEventListener("click", () => {
  ...
  setTimeout(() => {
    try {
      frame.contentWindow.postMessage({ type: 'reduceVolume', volume: 0.3 }, '*');
    } catch (e) {
      console.log('Cannot reduce firework volume yet');
    }
  }, 500);
...
function playCustomAudio(delay = 1500) {
  setTimeout(() => {
    ...
    audio1.play().catch(err => {
      console.log('Audio1 play failed:', err);
    });
  }, delay);
}
